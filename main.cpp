...
//GRAPH VARIABLES ------------------------------------------------------------------------------------------------------
   ...
   n_index* Index_inv ;
//HELPERS --------------------------------------------------------------------------------------------------------------
   int entry=0, lineNumber=0, OPTION=2,entry_inv=0, numberOfQuestions=0;
...
// Case Q for question on the graph ------------------------------------------------------------------------------------
               ...
               cout<<"Question"<<endl;
               cout<<numberOfQuestions<<"------BBFS-------"<<BBFS(Index, Buffer, atoi(part2), Index_inv, Buffer_inv, atoi(part3), 50)<<" this is the answer"<<endl;
                 numberOfQuestions++;
             }
// End of case Q -------------------------------------------------------------------------------------------------------
          }
